...
export const ProductFeatures = () => {
  const mainFeatures = product.attributes.filter(
    (attribute) => attribute.attribute_group_id === ""
  );
  const otherFeatures = product.attributes.filter(
    (attribute) => attribute.attribute_group_id === "OTHERS"
  );
  ...
  return (
    <section>
      ...
      <h2 className="product-details-subtitle">Caracteristicas principales</h2>
